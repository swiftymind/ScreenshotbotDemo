        ...
        NavigationView {
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    // Metrics Cards - DEMO CHANGE: Total Sales card changed to RED! 🎯
                    LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 2), spacing: 16) {
                        MetricCard(title: "Total Sales", value: "$12,345", trend: "+12%", color: .red)  // Changed from .green to .red for demo!
